"""
Django settings for django_weather_app_with_mysql_database project.
...
SECRET_KEY = 'django-insecure-p=@il5a$#*7%-w@n4(01&zxa5u@k)v$!emmt$8dft46t(=39ra'
...
ROOT_URLCONF = 'django_weather_app_with_mysql_database.urls'
...
WSGI_APPLICATION = 'django_weather_app_with_mysql_database.wsgi.application'
